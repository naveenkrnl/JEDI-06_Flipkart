...
public class SQLQueriesConstants {
    ...
    public static final String VIEW_PROFESSOR_QUERY = "select user.userId, user.name, user.gender, professor.department, professor.designation, user.address, user.country, user.doj from professor inner join user on user.userId = professor.userId";
