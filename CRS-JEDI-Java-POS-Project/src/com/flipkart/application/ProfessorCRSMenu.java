...
public class ProfessorCRSMenu {
    ...
    // System.out.println(String.format("%20s %20s %20s", "COURSE CODE", "COURSE
    // CODE", "Students enrolled"));
    // try {
    // List<RegisteredCourseStudent> enrolledStudents = new
    // ArrayList<RegisteredCourseStudent>();
    // enrolledStudents = professorInterface.viewEnrolledStudents(profId);
    // for (RegisteredCourseStudent obj : enrolledStudents) {
    // System.out.println(
    // String.format("%20s %20s %20s", obj.getCourseCode(), obj.getCourseName(),
    // obj.getrollNumber()));
    // }
    //
    // } catch (Exception ex) {
    // System.err.println(ex.getMessage() + "Something went wrong, please try again
    // later!");
    // }
    // }
    //
    ...
    // List<Course> coursesEnrolled = professorInterface.getCourses(profId);
    // System.out.println(
    // String.format("%20s %20s %20s", "COURSE CODE", "COURSE NAME", "No. of
    // Students enrolled"));
    // for (Course obj : coursesEnrolled) {
    // System.out.println(
    // String.format("%20s %20s %20s", obj.getCourseCode(), obj.getCourseName(), 10
    // - obj.getSeats()));
    // }
    // } catch (Exception ex) {
